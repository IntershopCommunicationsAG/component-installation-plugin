...
class InstallPluginSpec extends AbstractProjectSpec {

    @Override
    Plugin getPlugin() {
        return new ComponentInstallPlugin()
    }
    ...
    def 'should add extension'() {
        ...
        then:
        project.extensions.getByName(InstallationExtension.INSTALLATION_EXTENSION_NAME)
    }
}
